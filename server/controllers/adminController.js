...
const approveOwner = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({success:true, message:"Successfully approved owner request"});
    } catch (error) {
        return res.status(500).json({success:false, message:error.message});
    }
}
...
const rejectOwner = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({success:true, message:"Successfully rejected owner request"});
    } catch (error) {
        return res.status(500).json({success:false, message:error.message});
    }
}
