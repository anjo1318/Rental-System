...
export default function RentingPaymentMethod({
  bookingData,
  onBack,
  onContinue,
}) {
  ...
  const loadUserData = async () => {
    try {
      ...
      if (userData) {
        ...
        console.log(
          "From local storgae nandito ito sa rentingPyanmentMethod barangay",
          user.barangay,
        );
      }
    } catch (error) {
  ...
  const calculatePricing = () => {
    ...
    // pricePerDay is actually pricePerHour based on your requirement
    ...
    if (period === "Hour") {
      totalHours = duration; // already in hours
      displayDuration = duration;
      durationLabel = "hours";
    } else {
      totalHours = duration * 24; // convert days to hours
      displayDuration = duration;
      durationLabel = "days";
    }
    ...
    return {
      rateLabel: "Rate Per Hour",
      rate: pricePerHour.toFixed(2),
      duration: displayDuration,
      durationLabel,
      totalHours,
      period,
      isSameDayRental: period === "Hour",
      ...
      >
        ...
        <View style={styles.unitPriceCard}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoValue}>
              {pricing.totalHours} hours ({pricing.duration}{" "}
